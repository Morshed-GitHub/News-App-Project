...
class ChipList2 extends StatefulWidget {
  const ChipList2({Key? key}) : super(key: key);

  @override
  _ChipList2State createState() => _ChipList2State();
}

class _ChipList2State extends State<ChipList2> {
  late Future<List> newsFuture;
  Future<List> getNewsByQuery() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=5c30b90b83eb4e83a8de50d2b3a790a1";
