...
class ChipList3 extends StatefulWidget {
  const ChipList3({Key? key}) : super(key: key);

  @override
  _ChipList3State createState() => _ChipList3State();
}

class _ChipList3State extends State<ChipList3> {
  late Future<List> newsFuture;
  Future<List> getNewsByQuery() async {
    String url =
        "https://newsapi.org/v2/everything?q=tesla&from=2021-12-20&sortBy=publishedAt&apiKey=5c30b90b83eb4e83a8de50d2b3a790a1";
