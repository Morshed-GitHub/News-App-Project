...
class ChipList4 extends StatefulWidget {
  const ChipList4({Key? key}) : super(key: key);

  @override
  _ChipList4State createState() => _ChipList4State();
}

class _ChipList4State extends State<ChipList4> {
  late Future<List> newsFuture;
  Future<List> getNewsByQuery() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=us&title=top&apiKey=5c30b90b83eb4e83a8de50d2b3a790a1";
